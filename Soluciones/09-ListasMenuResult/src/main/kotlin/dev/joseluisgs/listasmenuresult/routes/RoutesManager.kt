package dev.joseluisgs.listasmenuresult.routes
...
object RoutesManager {
    ...
    fun initMainStage(stage: Stage) {
        ...
        val scene = Scene(parentRoot, 600.0, 420.0)
        // scene.stylesheets.add(getResource(Style.DAM.css).toExternalForm())
        stage.title = "Lista con Menu"
    ...
    fun initAcercaDeStage() {
        ...
        val stage = Stage()
        stage.title = "Acerca De Lista Menu"
        stage.scene = scene
